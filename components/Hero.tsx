...
export const Hero: React.FC<HeroProps> = ({ activeMenu = 'home' }) => {
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-black flex items-center justify-center">
      ...
      {/* CONTENT CONTAINER: Centered with max-width for Ultra-Wide Screens */}
      <div className="container mx-auto px-4 md:px-8 lg:px-16 w-full max-w-[1400px] relative z-10 min-h-screen flex flex-col justify-center pt-24 md:pt-0 pb-12 md:pb-0">

        {/* CSS GRID LAYOUT: 1 column on mobile, 2 columns on desktop */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4 h-full w-full relative">

          {/* LEFT: Text Content */}
          <div className="w-full pt-6 md:pt-10 flex flex-col justify-center z-20">
            <motion.div
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-black text-white leading-[1.1] md:leading-[1] mb-4 md:mb-6 tracking-tighter break-words hyphens-auto">
                DESIGNING <br />
              ...
              {/* Bottom Stats */}
              <div className="flex flex-wrap gap-6 md:gap-8 lg:gap-12 border-t border-white/10 pt-4 md:pt-6 pb-8 md:pb-0">
